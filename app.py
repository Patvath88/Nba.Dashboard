...
def main() -> None:
    ...
    st.set_page_config(
        ...
        layout="wide",
        theme={
            "primaryColor": "#C9082A",          # accent red
            "backgroundColor": "#041E42",       # dark navy background
            "secondaryBackgroundColor": "#17408B",  # royal blue cards
    ...
    def validate_key_once(key: str) -> bool:
        try:
    ...
    if not validate_key_once(api_key):
        st.error(
