# -------------------------------------------------
# HOT SHOT PROPS — NBA AI DASHBOARD (STABLE BLACK BACKGROUND)
# -------------------------------------------------
...
# -------------------------------------------------
# STYLE — black background, retro orange accents
# -------------------------------------------------
st.markdown("""
<style>
body {
...
# MAIN
# -------------------------------------------------
st.title("🏀 Hot Shot Props — AI NBA Dashboard (Stable)")
st.caption("AI model trains on past games and explains its predictions.")
...
if pred_next:
    ...
    **{form5['AST']:.1f} AST**, and **{form5['FG3M']:.1f} 3PM**.  
    These trends heavily influenced projection weighting — scoring consistency, rebound activity,  
    and assist stability were prioritized while defensive variance was smoothed out.
    """
