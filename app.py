...
# ------------------ Sidebar (now with Home button) ----
with st.sidebar:
    # NEW: Home Screen button
...
player_name = next((p['full_name'] for p in get_active_players_fast() if p['id']==player_id), "Player")
